...
export const allJoinedEventsController = async (req, res) => {
...
export const sendCodeToEmailController = async (req, res) => {
...
export const changePersonalController = async (req, res) => {
...
export const changeProfilePhotoController = (req, res) => {
